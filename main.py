...
def bidirectional_search(forward_fringe_list, backward_fringe_list, closed_list):
    ...
    no_of_states_generated = 2 # Initial state is already generated, from both directions
    no_of_states_expanded = 0
    found = False
    while not found:
    ...
    return solution_states, no_of_states_generated, no_of_states_expanded
...
def agent(goal_config, instance):
    ...
    closed_list = {}
    solution, generated_state_count, expanded_state_count = bidirectional_search(forward_fringe_list, backward_fringe_list, closed_list)
    # Print the solution
    print('Statistics about the solution:')
    print(f'No.of states generated by bi-drectional search: {generated_state_count}')
    print(f'No.of states expanded by bi-directional search: {expanded_state_count}')
